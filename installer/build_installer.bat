...
if "%INSTALLER_OUTPUT_NAME%"=="" set "INSTALLER_OUTPUT_NAME=HWOnlineSetup.exe"
set "INSTALLER_TITLE=%INSTALLER_OUTPUT_NAME:.exe=%"
set "ASSEMBLY_INFO=%TEMP%\HWOnlineSetup.AssemblyInfo.%RANDOM%%RANDOM%.cs"
