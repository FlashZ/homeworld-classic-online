...
class ProductProfile:
    ...
    backend_valid_versions: tuple[str, ...] = ("1.00",)
    backend_default_game_name: str = ""

    @property
    def cd_key_product_name(self) -> str:
...
HOMEWORLD_PRODUCT_PROFILE = ProductProfile(
    ...
    backend_valid_versions=("0110",),
    backend_default_game_name="homeworld",
)
...
CATACLYSM_PRODUCT_PROFILE = ProductProfile(
    ...
    backend_valid_versions=("1.0.0.1", "1001"),
    backend_default_game_name="cataclysm",
)
